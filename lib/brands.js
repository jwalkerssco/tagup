...
function create(deps) {
  ...
  return { list, recognize, find, pick, setStatus, approveConfident, setOverride, scoreCandidates, brandWords, matchFilename, bulkUpload, wikipediaArticleImages, brandKeyFor, brandKeyForAsync, attachLogos, rows, normBrand, titleCase, callModel, wikiSearch };
}

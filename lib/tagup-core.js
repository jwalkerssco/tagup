...
(function (root, factory) {
  ...
  const TAG_CSS =
    ...
    ".tag.modern .mpill{font-family:var(--head);font-weight:700;font-size:calc(.11in*var(--u));line-height:1;padding:calc(.035in*var(--u)) calc(.1in*var(--u));border-radius:calc(.14in*var(--u));white-space:nowrap;overflow:hidden;text-overflow:ellipsis;max-width:100%;margin-top:calc(.02in*var(--u))}" +

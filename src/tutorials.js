...
export const TUTORIALS = [
  { id: "start", title: "Your first tag in three minutes", minutes: 3, for: "everyone", video: null,
    ...
    steps: ["Accounts -> Upload account list: Account Name, Account #, Address, Sales Rep, Sales Rep #. Or add one by hand.", "Request a tag -> pick the store, the tag type, the item and the price.", "Queue -> tick the request, choose the sheet in the printer, Make a print batch.", "Print batches -> Print sheet -> print at 100% with margins set to None.", "Mark printed. The rep sees it flip to Printed on their phone."] },
  ...
  { id: "team", title: "Invite the team", minutes: 2, for: "admins", video: null,
    ...
    steps: ["Team -> the card lists every sales rep your account list names who is not on the team yet. Invite each; their Rep # rides along.", "Or Team -> Invite: an email, a role, and for a rep the Sales Rep # from your list.", "Rep: asks for tags for their stores, sees their own requests. Manager: works the queue and prints, for their team. Admin: everything, including styles, materials, stores and the item list.", "Optional: make teams and put stores and people on them -- a manager then sees only their team's work.", "They get an email with a link; accepting it sets their password and lands them in your workspace."] },
];
